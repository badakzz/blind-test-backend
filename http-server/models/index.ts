...
import RoadmapTicket from './RoadmapTicket'
...
Song.hasMany(Chatroom, { foreignKey: 'current_song_playing_id' })
...
User.hasMany(RoadmapTicket, { foreignKey: 'user_id' })
RoadmapTicket.belongsTo(User, { foreignKey: 'user_id' })
